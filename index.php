...
?>
         ...
         <main class="fix">
            <!-- tp-hero-area-start -->
            <div class="tp-hero-2__area tp-hero-2__ptb tp-hero-2__plr z-index fix p-relative" style="height:100vh"
                  ...
                  <div class="row g-0 align-items-end">
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-hero-2__title-box">
                           <h3 class="tp-hero-2__title tp-char-animation">One stop solution for healthcare</h3>
                        </div>
                        <div class="tp-hero-2__btn">
                           <a class="tp-btn-green wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s"
                              href="service-details.php">Get Started For Free</a>
                        </div>
                     ...
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-hero-2__right text-end p-relative">
                           <div class="tp-hero-2__main-img wow tpfadeRight" data-wow-duration=".9s"
                              data-wow-delay=".5s">
                              <img src="assets/img/home-banner.png" alt="" class="w-68">
                           </div>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="tp-payment__content tp-payment__content-space">
                                    ...
                                    <a href="service-details.php">Explore Invoicing Tools<i class="far fa-arrow-right"></i></a>
                                 </div>
                              </div>
                              <div class="col-md-6">
                  ...
                  <div class="row g-0 justify-content-center">
                     <div class="col-xl-7">
                        <div class="tp-payment-method__title-box text-center mb-20">
                           <h3 class="tp-section-title-lg pb-10">All major <br>
                              payment methods</h3>
                           <p>We've got all your payments covered</p>
                        </div>
                     </div>
                        ...
                        <div class="tp-service-2__item-wrapper p-relative">
                           <div class="tp-service-2__item d-flex justify-content-between flex-column">
                              ...
                              <div class="tp-service-2__text">
                                 <h4 class="tp-service-2__title-sm"><a href="service-details.php">Online</a></h4>
                                 <a class="tp-service-2__link" href="service-details.php">Explore<i class="far fa-arrow-right"></i></a>
                              </div>
                           </div>
                     ...
                     <div class="col-xl-3 col-lg-3 col-md-6 mb-40 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".6s">
                        <div class="tp-service-2__item-wrapper p-relative">
                           <div class="tp-service-2__item d-flex justify-content-between flex-column">
                              ...
                              <div class="tp-service-2__text">
                                 <h4 class="tp-service-2__title-sm"><a href="service-details.php">Bank Transfers</a></h4>
                                 <a class="tp-service-2__link" href="service-details.php">Explore<i class="far fa-arrow-right"></i></a>
                              </div>
                           </div>
                     ...
                     <div class="col-xl-3 col-lg-3 col-md-6 mb-40 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".8s">
                        <div class="tp-service-2__item-wrapper p-relative">
                           <div class="tp-service-2__item d-flex justify-content-between flex-column">
                              ...
                              <div class="tp-service-2__text">
                                 <h4 class="tp-service-2__title-sm"><a href="service-details.php">Keyed</a></h4>
                                 <a class="tp-service-2__link" href="service-details.php">Explore<i class="far fa-arrow-right"></i></a>
                              </div>
                           </div>
                     ...
                     <div class="col-xl-3 col-lg-3 col-md-6 mb-40 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
                        <div class="tp-service-2__item-wrapper p-relative">
                           <div class="tp-service-2__item  d-flex justify-content-between flex-column">
                              ...
                              <div class="tp-service-2__text">
                                 <h4 class="tp-service-2__title-sm"><a href="service-details.php">In-Person</a></h4>
                                 <a class="tp-service-2__link" href="service-details.php">Explore<i class="far fa-arrow-right"></i></a>
                              </div>
                           </div>
                     ...
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-account-step-wrapper">
                           ...
                           <div class="tp-account-btn-box">
                              <a class="tp-btn-green mb-15" href="register.php">Open An Account in Minutes</a>
                     ...
                     <div class="col-xl-6 col-lg-6">
                        <div class="tp-faq-left-wrapper p-relative">
                           ...
                           <div class="tp-faq-btn">
                              <a class="tp-btn-green" href="contact.php">Get in Touch</a>
                           </div>
