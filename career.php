<?php 
$title = "Career | Connected Health Platform | Leuk Health";
                     ...
                     <div class="row justify-content-center">
                        <div class="col-xl-12">
                           <div class="breadcrumb__content text-center z-index-3 mb-60">
                              <h3 class="breadcrumb__title">Build Your Career With <br> The Lemon Team</h3>
                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="carrer-banner-img-item parallax-main">
                           <img class="parallax-img" src="assets/img/career/image-2.png" alt="" data-parallax='{"y": 300, "smoothness": 10}'>
                        </div>
                     </div>
                  ...
                  <div class="row align-items-end mb-60">
                     <div class="col-xl-7 col-lg-6 wow tpfadeLeft" data-wow-duration=".9s" data-wow-delay=".3s">
                        <div class="tp-platform-section-box">
                           <h5 class="inner-section-subtitle pb-10">What we offer</h5>
                           <h3 class="tp-section-title">Our Platform</h3>
                        </div>
                     </div>
                           ...
                           <div class="row-custom">
                              <div class="col-custom">
                                 ...
                                 <div class="tp-panel-item-2">
                                    <div class="tp-panel-content-2">
                                       <span>01.</span>
                                       <h4 class="tp-panel-title-2">Live Security</h4>
                              ...
                              <div class="col-custom">
                                 <div class="tp-panel-item">
                                    <div class="tp-panel-content">
                                       <span>02.</span>
                                       <h4 class="tp-panel-title child-two">Hack Protection</h4>
                                    </div>
                                 </div>
                                 <div class="tp-panel-item-2">
                                    <div class="tp-panel-content-2">
                                       <span>02.</span>
                                       <h4 class="tp-panel-title-2">Hack Protection</h4>
                                       <p>Blocks infected website tracking
                                          programs and annoying.</p>
                                    </div>
                                 </div>
                              ...
                              <div class="col-custom active">
                                 <div class="tp-panel-item">
                                    <div class="tp-panel-content">
                                       <span>03.</span>
                                       <h4 class="tp-panel-title child-three">Live Security</h4>
                                    </div>
                                 </div>
                                 <div class="tp-panel-item-2">
                                    <div class="tp-panel-content-2">
                              ...
                              <div class="col-custom">
                                 <div class="tp-panel-item">
                                    <div class="tp-panel-content">
                                       <span>04.</span>
                                       <h4 class="tp-panel-title child-four">Online Support</h4>
                                    </div>
                                 </div>
                                 <div class="tp-panel-item-2">
                                    <div class="tp-panel-content-2">
                                       <span>04.</span>
                                       <h4 class="tp-panel-title-2">Online Support</h4>
                                       <p>Blocks infected website tracking
                                          programs and annoying.</p>
                                    </div>
                                 </div>
