   <?php
   $title = "Contact | Connected Health Platform | Leuk Health";
   ...
   <div class="about-img-area mb-100 z-index-3">
      <div class="container">
         <div class="row">
            <div class="col-12">
               <div class="about-img about-img-height p-relative" data-background="assets/img/contact/contact-banner.jpg">
            ...
            <div class="col-xl-7 col-lg-6">
               <div class="contact-form-right-warp">
                  <div class="postbox__comment-form">
                     <form id="contactus-form" action="" class="box" novalidate>
                        <div class="row gx-20">
                           <div class="col-12">
                           ...
                           <div class="col-12">
                              <div class="postbox__comment-input mb-30">
                                 <input id="contact_location" name="contact_location" type="text" class="inputText" required>
                                 <span class="floating-label">Location/City</span>
                                 <span class="error-message" id="contact_location-error"></span>
                              </div>
                           </div>
                           <!-- <div class="col-12">
                           ...
                           <div class="col-xxl-12">
                              <div class="postbox__comment-input mb-30">
                                 ...
                                 <span class="error-message" id="contact_message-error"></span>
                              </div>
                           </div>
                           <div class="col-xxl-12">
